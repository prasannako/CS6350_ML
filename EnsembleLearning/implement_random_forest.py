...
def two_d(training_data, testing_data):
    num_trees = 50
    for size_attribute_subset in [2,4,6]:
        train_errors = []
        test_errors = []
        rf = BaggingAlgorithm(num_iterations=num_trees, sample_size=5000) 
...
def main():
    ...
    two_d(training_data, testing_data)
