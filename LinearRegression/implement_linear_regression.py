...
def batch(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance):
...
def stochastic(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance):
...
def analytical(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance):
...
def main():
    ...
    train_file_path = os.path.join(current_directory, 'concrete', 'train.csv')
    test_file_path = os.path.join(current_directory, 'concrete', 'test.csv')
    ...
    batch(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance)
    stochastic(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance)
    analytical(X_train, y_train, X_test, y_test, r, n_epoch, w_change_tolerance)
